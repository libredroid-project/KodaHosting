...
public final class ItemMessageSentBinding implements ViewBinding {
  ...
  private ItemMessageSentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView ivMessageStatus, @NonNull LinearLayout layoutMessage,
      @NonNull TextView tvMessageContent, @NonNull TextView tvMessageTime) {
  ...
  public static ItemMessageSentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageSentBinding((ConstraintLayout) rootView, ivMessageStatus, layoutMessage,
